...
-- Dumping structure for table bookdb.book
...
-- Dumping data for table bookdb.book: 15 rows
...
-- Dumping structure for table bookdb.migrations
...
-- Dumping data for table bookdb.migrations: 2 rows
...
-- Dumping structure for table bookdb.transaction
...
CREATE TABLE IF NOT EXISTS `transaction` (
  ...
  KEY `transaction_bookid_foreign` (`bookId`)
) ENGINE=MyISAM AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Dumping data for table bookdb.transaction: 15 rows

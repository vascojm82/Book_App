...
@section('tables')
      ...
      <!--- Book Table buttons--->
      <div class="col-md-6 button_block" id="buttons_1">
      ...
      <div class="col-md-6 button_block" id="buttons_2">
            <div class="btn-toolbar">
      ...
      <div class="col-xs-12 outer_container" id="outer_body">
              <div class="col-xs-12 container inner_container" id="tables">
                    <!--- Book Table --->
